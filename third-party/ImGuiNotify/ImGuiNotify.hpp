...
public:
    ...
    */
    ...
    /**
     * @brief Resets the creation time of the toast to current time.
     * Useful for toasts created before ImGui initialization.
     */
...
namespace ImGui
{
    ...
    {
        const ImVec2 mainWindowSize = ImGui::GetIO().DisplaySize;
        ...
        for (size_t i = 0; i < notifications.size(); ++i)
        {
            ...
            SetNextWindowPos(ImVec2(mainWindowSize.x - NOTIFY_PADDING_X, mainWindowSize.y - NOTIFY_PADDING_Y - height), ImGuiCond_Always, ImVec2(1.0f, 1.0f));
            ...
            SetNextWindowSizeConstraints(ImVec2(225.0f, 0.0f), ImVec2(FLT_MAX, FLT_MAX));
            ...
            // Here we render the toast content
            {
                ...
                if (!NOTIFY_NULL_OR_EMPTY(content))
                {
                    ...
                    TextWrapped("%s", content); // Render content text
                }
